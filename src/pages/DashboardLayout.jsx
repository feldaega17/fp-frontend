...
export default function DashboardLayout() {
    ...
    const navItems = [
        { path: '/dashboard', icon: '📋', label: 'My Tasks', exact: true },
        { path: '/dashboard/tasks/new', icon: '➕', label: 'New Task', exact: false },
        { path: '/dashboard/categories', icon: '📁', label: 'Categories', exact: true },
        { path: '/dashboard/users', icon: '👥', label: 'Browse Users', exact: false },
    ];
